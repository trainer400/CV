...
\begin{document}
    ...
    \begin{tcolorbox}[grow to left by=0.55cm,colframe=white,colback=white]
        ...
        {System Integrator}{at PoliMOVE Racing Team}
        {
            ...
            {
                \begin{compactitem}[-]
                    \item Deployed multi threaded software in a complex ROS2 project;
                    \item Designed and deployed Docker development environments built with Gitlab CI/CD;
                    \item Designed and deployed a fully code generated C++ CAN bus interface for DBC files;
        ...
        {Software Team Leader}{at Skyward Experimental Rocketry}
        {
            ...
            \newline Achieved the following goals: 
            {
                \begin{compactitem}[-]
                    ...
                    \item Understood the working principles of a hybrid rocket engine along with its needs in terms of software features;
